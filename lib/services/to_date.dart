...
import 'package:inneapolis/resources/app_internal_variable_const.dart';
...
String substractDates(DateTime one, DateTime two, context) {
  final Duration duration = one.difference(two);
  return "${duration.inMinutes} ${S.of(context).minutes}";
}
